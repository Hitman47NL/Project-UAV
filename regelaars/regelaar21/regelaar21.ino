...
const float m = 1.560;             // kg;       Massa van de UAV
const float Iz = 0.115405;          // kgm2;     Massatraagheid van de UAV
float Fx, Fy, Mz = 0.01;         // N, N, Nm; Stuurkrachten en stuurmoment
const float Mstoor = 0.12;       // Nm;       Stoormoment door helicoptereffect van de blowers
const float Fmin = -0.24832, Fmax = 0.213122; // Maximering van stuwkracht voor meer realistische simulatie
...
float Kp = 0.0, Kd = 0.0, Ki = 0.0;    // regelaarparameters PID-regelaar
...
void Poolplaatsing() {
  const float Re = 2.5, Im = 4, pool3 = 0.005;     // Poolplaatsing Im(pool) = 2 x Re(pool): Doorschot = 20%
