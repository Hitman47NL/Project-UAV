...
#define chipSelect 53  //voor het schrijven naar de SD kaart
...
#define maxBufferSize 4096          // Definieer maximale grootte van buffer
...
void setup() {
  ...
  lcd.setCursor(0, 0);
  lcd.print("Done!");  //Zodat de user weet dat er iets gebeurd
  lcd.clear();
}
